...
//  以下のように設定するとFlowerはリビジョン0状態になってしまう。
//  qmlRegisterExtendedType<Flower, FlowerExtension>(uri, 1, 2, "Flower");

  //ver 1.3
//  qmlRegisterRevision<Flower, 0>(uri, 1, 3);
  qmlRegisterType<ColorfulFlower>(uri, 1, 3, "Flower");
  qmlRegisterExtendedType<ColorfulFlower, FlowerExtension>(uri, 1, 3, "Flower");

  //ver 1.4
  qmlRegisterType<RandomColorGenerator>(uri, 1, 4, "RandomColorGenerator");
}
